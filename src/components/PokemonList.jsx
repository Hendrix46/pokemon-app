...
const PokemonList = () => {
    ...
    const [pokeData, loading, disable, setPokeData] = usePokemonData(perPage, currentPage);
                ...
                <div className="d-flex justify-content-between mt-5">
                    ...
                    <div className="form-group row">
                        ...
                        <div className="col-sm-4">
                            <select className="form-control" onChange={handlePerPageChange} value={perPage}>
                    ...
                    <div className="form-group row">
                        <label className="col-sm-4 col-form-label">Page: {currentPage}</label>
